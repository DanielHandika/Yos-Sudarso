...
$sql1="UPDATE bebasan SET bill='$bebas',status='belum',sudahbayar='0',kasir='$usr',tgl_input='$now' WHERE student_id='$murid' AND jenis_id='$jenis' AND period_id='$period'";
...
$sql2="INSERT INTO bebasan VALUES('','$period','$murid','$jenis','$bebas','belum','0','$usr','$now')";
