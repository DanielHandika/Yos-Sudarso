                                    ...
                                    <p class="sub-header">
                                        Tombol Reset akan menghapus semua data dan mengembalikan aplikasi seperti saat pertama diinstal
                                         ...
                                         <div class="alert alert-danger text-danger alert-dismissible fade show" role="alert">
                                                ...
                                                <strong>Peringatan!</strong> Dengan Klik Tombol dibawah ini akan menghapus secara permanen semua data yang sudah ada!!!
                                            </div>

                                    <div class="table-responsive">

                                        <?php  if ($chmod >= 5 || $_SESSION['jabatan'] == 'admin') { ?>
                                        <button type="button" class="btn btn-icon waves-effect waves-light btn-danger btn-block" data-toggle="modal" data-target="#reset"> <i class="fas fa-times"></i> <b>RESET SEMUA DATA</b></button>
                                      <?php } ?>
                                      ...
                                      <br>
                                       ...
                                       <div class="alert alert-warning text-warning alert-dismissible fade show" role="alert">
                                                ...
                                                <strong>Peringatan!</strong> Dengan Klik Tombol dibawah ini akan menghapus secara permanen semua data pembayaran yang sudah ada!!! Data siswa, kelas dan alumni akan tetap ada.
                                            </div>

                                       <?php  if ($chmod >= 5 || $_SESSION['jabatan'] == 'admin') { ?>
                                        <button type="button" class="btn btn-icon waves-effect waves-light btn-warning btn-block" data-toggle="modal" data-target="#resetdata"> <i class="fas fa-times"></i> <b>RESET Data Transaksi saja</b></button>
                                      <?php } ?>
...
<!-- END FOOTER-->
 ...
 <div id="reset" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                    ...
                                    <div id="resetdata" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p class="sub-header">
                                     <b>   Tindakan ini akan mengakibatkan data pembayaran yang ada terhapus permanen. Data siswa, kelas dan alumni akan tetap ada. </b>
                                                      </p>

                                                         <div class="modal-footer">
                                                            <div class="col-9">
                                                                
                                                    <a href="set_keamanan_reset?reset=2" class="btn btn-danger waves-effect waves-light">Ya, Saya Paham</a>
                                                </div>
