...
?>
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title"> <a onclick="window.location.href='configuration/config_phpspreadsheet?forward=report_trx&start=<?php echo $start; ?>&end=<?php echo $end; ?>&tipe=all'"   class="btn btn-xs btn-primary waves-effect waves-light btn-md"><i class="fas fa-download"> Excel</i> </a></h4>
