...
$halaman = "pos_setting_all"; // halaman
...
<div class="card-header bg-danger text-white">
                                        ...
                                        <h6 class="card-title mb-0 text-white">Perhatian! Dengan Klik Simpan, apabila ada, data tagihan yang lama akan ditimpa dan semua siswa mendapat tagihan yang sama</h6>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                    <div class="card-box">
                                        <h4 class="header-title mb-3">Tagihan sama untuk semua siswa</h4>
