...
<head>
    <meta charset="utf-8" />
    <title>Login | BiSa Finance</title>
...
<body class="authentication-bg bg-indigo authentication-bg-pattern d-flex pb-0 vh-100">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card-box">
                        ...
                        <div class="row">
                            <div class="col-4">
                        <i class="fa fa-desktop fa-7x text-warning"></i>
                    </div>
                        <div class="col-8 ">
                        <h2>Login Admin</h2>
                        <style> 
             ...
             <h2 class=" mb-1 mt-4 text-center ">BiSa Finance</h2>
