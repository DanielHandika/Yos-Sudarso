                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Atur Pembayaran</a></li>
...
<?php } else if ($msg == "exist"){ ?>
 <div id="myAlert" class="alert alert-danger text-danger alert-dismissible fade show" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span>  </button>
<strong>GAGAL!</strong> Pos tersebut sudah ada </div>
...
<?php } else if ($msg == "nonexist"){ ?>
 <div id="myAlert" class="alert alert-danger text-danger alert-dismissible fade show" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span>  </button>
<strong>GAGAL!</strong> Pos yang diedit tidak diketemukan </div>
...
<?php } else if ($msg == "update"){ ?>
 <div id="myAlert" class="alert alert-info text-info alert-dismissible fade show" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span>  </button>
<strong>Berhasil!</strong> Pos tersebut sudah diupdate </div>
               ...
               ?>                                      
                                            ...
                                            <td >
                                               ...
                                               <?php  if ($chmod >= 5 || $_SESSION['jabatan'] == 'admin') { ?>
                                                ...
                                                onclick="window.location.href='component/delete/delete_pos?no=<?php echo $fill['id'].'&'; ?>forward=<?php echo "pos_bayar".'&';?>forwardpage=<?php echo $halaman.'&'; ?>chmod=<?php echo $chmod; ?>'"
