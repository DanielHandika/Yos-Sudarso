...
?>
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                   <h4 class="header-title"> <a onclick="window.location.href='configuration/config_phpspreadsheet_multi?forward=bulanan&t=<?php echo $t; ?>&c=<?php echo $c; ?>&tipe=bulanan'"   class="btn btn-xs btn-primary waves-effect waves-light btn-md"><i class="fas fa-download"> Excel</i> </a></h4>
                                ...
                                <tr>
                                    ...
                                    while($rowan=mysqli_fetch_assoc($sql3)){?>
                                        ...
                                        <?php  while($data=mysqli_fetch_array($sql)) { 
                                            ...
                                            echo '<th class="table-danger text-primary">'.$sql4['bulanan_status'].'</th>';
                                                } else if($sql4['bulanan_status']=='sudah') {
                                                    echo '<th class="table-success text-primary">'.$sql4['bulanan_status'].'</th>';
                                                }
                                        }  mysqli_data_seek($sql, 0);
