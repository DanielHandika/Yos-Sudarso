                           ...
                           <div class="col-md-6">
                                    <div class="card-box">
                                     ...
                                     <form method="post" action="">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Pembayaran tidak bisa dihapus setelah lewat dari (sekian hari)</label>
                                                <input type="text" class="form-control" value="<?php echo $deletelimit;?>" name="limithapus">
                                            </div>
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
          ...
          $url = mysqli_real_escape_string($conn, $_POST["url"]);
           $time = mysqli_real_escape_string($conn, $_POST["time"]);
            ...
            $del = mysqli_real_escape_string($conn, $_POST["limithapus"]);

            $sql="UPDATE backset SET url='$url', footer='$foo', harihapus='$del', sessiontime='$time'";
