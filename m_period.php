...
if(isset($_POST['simpan'])){
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          $sql="INSERT INTO periode (no,period_start,period_end,period_name,status) VALUES('','$awal','$akhir','$nama','active')";
          ...
          if(mysqli_query($conn,$sql)){
           ...
           $sql="INSERT INTO periode (no,period_start,period_end,period_name,status) VALUES('','$awal','$akhir','$nama','inactive')";
