                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <!-- PERBAIKAN 1: FORM PENCARIAN DIBUAT RESPONSIVE -->
                                    <!-- Mengganti .form-inline dengan grid system agar bisa stack di mobile -->
                                    <form method="get">
                                        <div class="form-row align-items-center">
                                            <div class="col-sm-12 col-md-3 mb-2">
                                                <label for="tahunAjaran" class="sr-only">Tahun Ajaran</label>
                                                <select class="form-control" name="t" id="tahunAjaran">
                                                     <?php
                                            ...
                                            <div class="col-sm-12 col-md-3 mb-2">
                                                ...
                                                <input type="text" class="form-control" id="nis" name="s" placeholder="Masukkan NIS Siswa" autocomplete="off">
                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-auto ml-md-auto mb-2">
                                                 <a data-toggle="modal" data-target="#myModal" class="btn btn-warning waves-effect waves-light text-white btn-block">
...
?>
                        <!-- PERBAIKAN 2: LAYOUT INFO SISWA DIBUAT RESPONSIVE -->
                        <!-- Menggunakan col-lg-*, col-md-* dan col-12 agar layout bisa stack di mobile -->
                        <div class="row">
                            <!-- Kolom Foto Siswa -->
                        ...
                        <!-- PERBAIKAN 3: LAYOUT TABEL TRANSAKSI DIBUAT RESPONSIVE -->
                        <!-- Menggunakan col-lg-* dan col-12 agar tabel menjadi 1 kolom di mobile -->
                        <div class="row">
                            <div class="col-lg-6 col-12 mb-3 mb-lg-0">
                                <div class="card-box">
                                    <h4 class="header-title mb-4">Transaksi Bulanan Terakhir</h4>
                                    <!-- Menambahkan table-responsive untuk keamanan -->
                                    <div class="table-responsive">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="home">
                                            ...
                                            <!-- PERBAIKAN 4: MEMBUNGKUS TABEL LEBAR DENGAN .table-responsive -->
                                            <div class="table-responsive">
                                                ...
                                                <tr >
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php 
                                                            ...
                                                            echo ' <td class="table-success"><a href="pay_receipt?no='.$qs['no'].'&tipe=1">'.date('d/m/y',strtotime($qs['tgl_input'])).'</a> </td>';
                                                                } else{
 ...
 <!-- sample modal content -->
                                     ...
                                     <div class="modal-dialog">
                                         <div class="modal-content">
                                             ...
                                             <form method="get">
                                                 ...
                                                 <label for="inputPassword4" class="col-3 col-form-label">Tahun Ajaran</label>
                                                 <div class="col-9">
                                                         <select class="form-control" data-toggle="select2" style="width: 200px" name="t">
                                                                 <?php
        $sql=mysqli_query($conn,"select * from periode order by no desc");
        while ($row=mysqli_fetch_assoc($sql)){
        if ($row['status']=='active')
    ...
    ?>
                                             ...
                                             <div class="form-group row">
                                                 ...
                                                 <div class="col-9">
                                                         <select class="form-control" data-toggle="select2" name="s" >
    ...
    <?php
        ...
        while ($row=mysqli_fetch_assoc($sql)){
        if ($_GET['s']==$row['nis'])
        echo "<option value='".$row['nis']."' selected='selected'>".$row['nis']." | ".$row['nama']."</option>";
        else
    ...
    ?>
                                             ...
                                             <div class="modal-footer">
                                                 ...
                                                 <button type="submit" class="btn btn-danger waves-effect waves-light">Pilih</button>
