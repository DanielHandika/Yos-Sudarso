      ...
      ?>
             ...
             <input type="hidden" name="q" value="<?php echo $jenis_id;?>">
                                    ...
                                    <?php if($a['jenis_pembayaran']=='bulanan'){?>    
                                        ...
                                        <a href="pos_setting_all?q=<?php echo $jenis_id;?>" class="btn btn-blue waves-effect waves-light">Terapkan ke Semua Siswa</a>


                                          <a href="pos_setting_class?q=<?php echo $jenis_id;?>" class="btn btn-dark waves-effect waves-light">Pilih Berdasarkan Kelas</a>
                                     
                                     
                                           <a href="pos_setting_student?q=<?php echo $jenis_id;?>" class="btn btn-warning waves-effect waves-light ">Pilih Berdasarkan Siswa</a>
                                         ...
                                         <a href="pos_jenis" class="btn btn-danger waves-effect waves-light ">Kembali</a>
                                          ...
                                          <?php } else {?>
                                             ...
                                             <a href="pos_setting_byall?q=<?php echo $jenis_id;?>" class="btn btn-purple waves-effect waves-light">Terapkan ke Semua Siswa</a>

                                            <a href="pos_setting_byclass?q=<?php echo $jenis_id;?>" class="btn btn-secondary waves-effect waves-light">Berdasar Kelas</a>
                                     
                                     
                                           <a href="pos_setting_bystudent?q=<?php echo $jenis_id;?>" class="btn btn-info waves-effect waves-light ">Berdasar Siswa</a>
                                      
                                     
                                         <a href="pos_jenis" class="btn btn-pink waves-effect waves-light ">Kembali</a>
...
$kls=$_GET['kelas'];
if($kls!='all'){
$ceknama=mysqli_fetch_assoc(mysqli_query($conn,"SELECT kelas FROM class WHERE no='$kls'"));
$namakelas=$ceknama['kelas'];
} else {
    ...
    ?>
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="header-title">Daftar Tarif Siswa untuk <?php echo $namakelas;?></h4>
