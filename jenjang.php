...
.smp-card-border {
    ...
    <div class="d-flex flex-column min-vh-100 justify-content-between">
        <header class="navbar navbar-expand-lg navbar-light bg-light shadow-sm p-2">
            ...
            <div class="container text-center">
                ...
                <div class="row justify-content-center g-4">
                    ...
                    <div class="col-12 col-md-4 col-lg-3">
                        <a href="login.php" style ="text-decoration: none; background-image: url(upload/image/pattern.png)" class="card jenjang-card h-100 shadow-sm border-0 tk-card-border" >
                    ...
                    <!-- Sekolah Dasar -->
                    <div class="col-12 col-md-4 col-lg-3">
                        <a href="login.php" style ="text-decoration: none; background-image: url(upload/image/pattern.png)" class="card jenjang-card h-100 shadow-sm border-0 sd-card-border">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center p-4">
                    ...
                    <!-- SMP -->
                    <div class="col-12 col-md-4 col-lg-3">
                        <a href="login.php" style ="text-decoration: none; background-image: url(upload/image/pattern.png)" class="card jenjang-card h-100 shadow-sm border-0 smp-card-border">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center p-4">
