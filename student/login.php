...
<head>
    <meta charset="utf-8" />
    <title>Login SISWA | BiSa Finance</title>
    ...
    <link href="../assets/css/bootstrap-dark.css" rel="stylesheet" type="text/css"  id="app-stylesheet" />


</head>

<body class="authentication-bg bg-indigo authentication-bg-pattern d-flex align-items-center pb-0 vh-100">
                                    ...
                                    <form class="form-horizontal" action="otentikasi.php" method="post">
                                          ...
                                          <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <input class="form-control" type="text" id="txtuser" name="txtuser" required placeholder="Nomor Induk Siswa Anda">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <input class="form-control" type="password" required="" id="txtpass" name="txtpass" placeholder="Password Anda" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row text-center mt-2">
                                            ...
                                            <br><br> <br>
                                            <div class="col-12">
                                                <a href="../login" class="btn btn-md btn-block btn-danger waves-effect waves-light mt-2">Kembali</a>
                                            </div>
                                        </div>
