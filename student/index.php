...
?>
            ...
            <div class="content-page bg-secondary">
                <div class="content">
...
<strong>Akunmu Sudah dinonaktifkan!</strong> Segera hubungi Pihak Sekolah apabila ingin mengaktifkan kembali </div>
<?php } ?>
                                ...
                                <div class="card-box widget-box-two widget-two-custom">
                                    <div class="media">
                                        ...
                                        <a href="summary.php" class="wigdet-two-content media-body">
                                            <p class="m-0 text-uppercase font-weight-medium text-truncate" title="Statistics">Total Tagihan</p>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card-box widget-box-two widget-two-custom ">
                                    <div class="media">
                                        ...
                                        <a href="history.php" class="wigdet-two-content media-body">
