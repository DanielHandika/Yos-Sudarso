                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $a['nama'];?>" placeholder="Nama Kota" required disabled>
                                            </div>

                                             <div class="form-group">
                                            <label for="pass1">Tempat Lahir<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="tempat" name="tempat" value="<?php echo $a['birth_place'];?>" placeholder="Nama Kota" required disabled>
                                            </div>

                                            <div class="form-group">
                                            <label for="pass1">Tanggal Lahir<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="datepicker" name="tgllahir" value="<?php echo $a['birth_date'];?>" required autocomplete="off" disabled>
                                            </div>

                                             <div class="form-group">
                                            <label for="pass1">Hobbi<span class="text-danger"></span></label>
                                            <input type="text" class="form-control" id="hobi" name="hobi"  placeholder="Membaca, menulis ..." value="<?php echo $a['hobi'];?>"disabled >
                                            </div>

                                             <div class="form-group">
                                            <label for="pass1">No.Hand Phone / Whatsapp<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="hp" name="nohp"  placeholder="628...." required autocomplete="off" value="<?php echo $a['nohp'];?>"disabled>
                                            </div>

                                            <div class="form-group">
                                            <label for="pass1">Nama Ibu<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="ibu" name="ibu"  placeholder="Ibu Kandung" autocomplete="off" value="<?php echo $a['ibu'];?>"disabled>
                                            </div>

                                             <div class="form-group">
                                            <label for="pass1">Nama Ayah<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="ayah" name="ayah"  placeholder="Ayah Kandung atau Wali" autocomplete="off" value="<?php echo $a['ayahwali'];?>"disabled>
                                            </div>

                                             <div class="form-group">
                                            <label for="pass1">No.HandPhone/Whatsap Orang Tua/Wali<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="waortu" name="waortu"  placeholder="+628.." autocomplete="off" value="<?php echo $a['waortu'];?>"disabled>
                                            </div>

                                            <div class="form-group text-warning">
                                                        <a>*Jika ada kesalahan data, silahkan hubungi operator</a>
                                                     </div>
...
echo "<script type='text/javascript'>window.location = '$forwardpage?key=$no&update=false';</script>";
     ...
     echo "<script type='text/javascript'>  alert('Profile berhasil di update, silahkan log out dan login lagi'); </script>";
}
