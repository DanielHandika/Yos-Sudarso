...
<?php } else if ($msg == "exist"){ ?>
 <div id="myAlert" class="alert alert-danger text-danger alert-dismissible fade show" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span>  </button>
<strong>GAGAL!</strong> Sudah ada kelas dengan nama yang serupa, silahkan periksa kembali </div>
    ...
    $namalabel="";
                                            ...
                                            <form class="form-inline" method="post">
                                                     ...
                                                     <div class="form-group mr-2">
                                                        <label for="exampleInputEmail2" class="mr-2"><?php echo $namalabel;?> Nama Kelas</label>
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light btn-md" name="class">UPDATE</button>

                                                                <?php } else {?>
                                <button type="submit" class="btn btn-blue waves-effect waves-light btn-md" name="class">SIMPAN</button>
...
if(isset($_POST['class'])){
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
           ...
           if(mysqli_num_rows($result)>0){
                  ...
                  if(mysqli_query($conn,$sql)){
                      echo "<script type='text/javascript'>window.location = '$forwardpage?insert=updated';</script>";
                    } else {
        ...
        $ceknama=mysqli_query($conn,"select * from class where kelas LIKE '%$nama%'");
        ...
        if(mysqli_num_rows($ceknama)>0){
          ...
          $sql="INSERT INTO class (no,kelas,status) VALUES('','$nama','active')";
